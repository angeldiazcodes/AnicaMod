...
public class AnicaChunkGenerator extends NoiseChunkGenerator<AnicaGenSettings> {
	...
	public AnicaChunkGenerator(IWorld worldIn, BiomeProvider provider, AnicaGenSettings settingsIn) {
