 ...
 */
public class AnicaHutPiece extends TemplateStructurePiece {
	 ...
	 */
	public AnicaHutPiece(TemplateManager templateManager, ResourceLocation templateResource, BlockPos pos, Rotation rotation) {
	 ...
	 */
	public AnicaHutPiece(TemplateManager templateManager, CompoundNBT nbt) {
		super(StructureRegistry.LITTLE_HUT_PIECE, nbt);
	...
	@Override
	public boolean func_225577_a_(IWorld world, ChunkGenerator<?> p_225577_2_, Random rand,
			MutableBoundingBox p_225577_4_, ChunkPos chunkPos) {
		...
		return super.func_225577_a_(world, p_225577_2_, rand, boundingBox, chunkPos);
	}
